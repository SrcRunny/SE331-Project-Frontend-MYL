...
<div class="flex justify-center items-center flex-wrap mb-5">
    ...
    <div class="flex justify-end items-center flex-wrap mr-6">
      ...
      <button v-if="!authStore.isAdvisor" type="button" class="text-white bg-gradient-to-r from-purple-500 to-pink-500 hover:bg-gradient-to-l focus:ring-4 focus:outline-none focus:ring-purple-200 dark:focus:ring-purple-800 font-medium rounded-lg text-sm px-5 py-2.5 text-center ml-auto">
        + Add Advisor
      </button>
    </router-link>
    </div>
